...
import { AlertTriangle, User, Lock, TrendingUp } from 'lucide-react';
        ...
        <div className="min-h-screen bg-app-bg flex items-center justify-center px-4 py-16 sm:px-6 lg:px-8">
            <div className="w-full max-w-md animate-in fade-in zoom-in duration-300">
                ...
                <div className="text-center mb-8">
                    ...
                    <h2 className="text-3xl font-black text-text-main tracking-tight">Welcome Back</h2>
                    <p className="text-secondary-500 dark:text-secondary-400 mt-2">Sign in to continue to Fitracker</p>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            <div className="flex justify-between mb-2 px-1">
                                <label className="block text-xs font-bold uppercase text-secondary-400">Password</label>
                                <button type="button" className="text-xs text-primary-600 hover:text-primary-700 font-bold hover:underline" onClick={() => alert("Forgot password flow not implemented yet.")}>Forgot?</button>
                            </div>
                            <div className="relative">
                        ...
                        <Button type="submit" className="w-full py-3.5 text-base font-bold shadow-soft-hover" disabled={loading} size="lg">
                ...
                <p className="mt-8 text-center text-sm text-secondary-500 dark:text-secondary-400">
                    ...
                    <button onClick={onSwitchToRegister} className="font-bold text-primary-600 hover:text-primary-700 hover:underline">
                        Sign up
                    </button>
                    {' • '}
